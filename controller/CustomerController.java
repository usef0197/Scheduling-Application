...
/**
 * Class to control customer data, including adding, deleting, and updating.
 */
...
public class CustomerController implements Initializable {
    ...
    private FilteredList<Customers> filteredCustomersList;
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            ...
            filteredCustomersList = new FilteredList<>(allCustomersList, p -> true);
            ...
            customerRecordsTable.setItems(filteredCustomersList);
            customerSearchField.textProperty().addListener((observable, oldValue, newValue) -> {
                filteredCustomersList.setPredicate(getCustomerPredicate(newValue));
            });
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    @FXML
    void customerSearchFieldAction(ActionEvent event) {
        filteredCustomersList.setPredicate(getCustomerPredicate(customerSearchField.getText()));
    }

    private Predicate<Customers> getCustomerPredicate(String searchText) {
        return customer -> {
            ...
            return String.valueOf(customer.getCustomerID()).contains(lowerCaseFilter) ||
                    ...
                    customer.getCustomerPostalCode().toLowerCase().contains(lowerCaseFilter) ||
                    customer.getCustomerPhone().toLowerCase().contains(lowerCaseFilter) ||
                    customer.getDivisionName().toLowerCase().contains(lowerCaseFilter);
        };
    }
    /**
     *
